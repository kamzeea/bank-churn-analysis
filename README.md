...
**Country:** Germany had the highest churn rate (31.39%), roughly double that of France (17.44%) and Spain (17.37%). Further diagnostic analysis was conducted to understand the root cause — see Germany's High Churn Rate section below."
...
## Germany's High Churn Rate
Initial analysis flagged Germany's churn rate (31.39%) as nearly double that of France (17.44%) and Spain (17.37%). To move beyond surface-level observation, we ran three diagnostic queries examining age distribution, balance tier concentration, and product ownership by country.

The analysis revealed that Germany's high churn is largely explained by its concentration of customers in high-risk segments — specifically upper-tier balances (936 of ~1,255 customers) and single-product ownership (41.54% churn rate, nearly double other countries). These are the same segments identified earlier as highest-risk across the full dataset.

Age analysis showed Germany consistently churns higher across all age groups, suggesting something beyond age or composition is driving the gap. This analysis does not fully explain why these segments churn more in Germany than in other countries — leaving open questions around customer experience, pricing sensitivity, or competitive differences that would require further investigation.
## Tools Used
